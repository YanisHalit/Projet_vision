...
void line_swp_max3_ui16matrix_basic          (uint16 **T, int i, int j0, int j1, uint8 **Y);
...
void max3_swp_ui16matrix_basic          (uint8 **X, int i0, int i1, int j0, int j1, uint16 **T, uint16 **Y_P, uint8 **Y_UP);
#ifdef __cplusplus
}
#endif
